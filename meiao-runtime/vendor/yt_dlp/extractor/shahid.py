...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = 'MEIAO_GIT_UPDATE_REDACTED_SHAHID_API_KEY'
    ...
    def _call_api(self, path, video_id, request=None):
        ...
        try:
            return self._aws_execute_api({
                'uri': '/proxy/v2/' + path,
                'access_key': 'MEIAO_GIT_UPDATE_REDACTED_AWS_ACCESS_KEY',
                'secret_key': 'MEIAO_GIT_UPDATE_REDACTED_AWS_SECRET_KEY',
            }, video_id, query)
