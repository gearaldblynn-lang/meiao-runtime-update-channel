...
def _add_images_internal(
    ...
    if hasattr(script, "add_track_ordered"):
...
def add_image_to_draft(
    ...
    try:
        ...
        logger.info(f"draft size: {draft_width}x{draft_height}, image size: {image_width}x{image_height}, transform_x: {transform_x}, transform_y: {transform_y}")
